...
namespace PersonelKayıt {
    ...
    public partial class PersonelVeriTabaniDataSet : global::System.Data.DataSet {
        ...
        public partial class Tbl_PersonelDataTable : global::System.Data.TypedTableBase<Tbl_PersonelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public Tbl_PersonelRow AddTbl_PersonelRow(string PerAd, string PerSoyad, string PerSehir, bool PerDurum, string PerMeslek) {
...
namespace PersonelKayıt.PersonelVeriTabaniDataSetTableAdapters {
    ...
    public partial class Tbl_PersonelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tbl_Personel] ([PerAd], [PerSoyad], [PerSehir], [PerDurum], [P" +
                "erMeslek]) VALUES (@PerAd, @PerSoyad, @PerSehir, @PerDurum, @PerMeslek)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PerId, PerAd, PerSoyad, PerSehir, PerDurum, PerMeslek FROM dbo.Tbl_Persone" +
                "l";
        ...
        public virtual int Insert(string PerAd, string PerSoyad, string PerSehir, global::System.Nullable<bool> PerDurum, string PerMeslek) {
            if ((PerAd == null)) {
            ...
            if ((PerDurum.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((bool)(PerDurum.Value));
            }
            else {
